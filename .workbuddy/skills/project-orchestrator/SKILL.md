...
```
智慧办公助手 (WX-APP-OA)
├── backend/       ─── .workbuddy/skills/backend-project/     ← 后端 API 服务
├── miniapp/       ─── .workbuddy/skills/miniapp-project/     ← 微信小程序前端
├── webapp/        ─── .workbuddy/skills/webapp-project/      ← Web 管理后台
├── test/          ─── .workbuddy/skills/test-project/         ← 测试
└── skill/         ─── 独立 skill 目录（API测试/调试/bug操作）
```
