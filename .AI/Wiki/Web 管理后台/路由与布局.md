...
- 头部与侧边栏：webapp/src/components/AppHeader/index.vue、webapp/src/components/AppSidebar/index.vue
...
subgraph "布局组件"
HEADER["components/AppHeader/index.vue"]
SIDEBAR["components/AppSidebar/index.vue"]
end
subgraph "状态管理"
...
participant H as "头部导航<br/>components/AppHeader/index.vue"
participant M as "侧边栏菜单<br/>components/AppSidebar/index.vue"
U->>R : 访问受保护路由
R->>S : 读取 token 与登录态
alt 未登录
R-->>U : 重定向到登录页
...
- [webapp/src/components/AppHeader/index.vue:21-47](file://webapp/src/components/AppHeader/index.vue#L21-L47)
- [webapp/src/components/AppSidebar/index.vue:66-95](file://webapp/src/components/AppSidebar/index.vue#L66-L95)
...
图表来源
- [webapp/src/components/AppHeader/index.vue:8-18](file://webapp/src/components/AppHeader/index.vue#L8-L18)
...
图表来源
- [webapp/src/components/AppSidebar/index.vue:57-63](file://webapp/src/components/AppSidebar/index.vue#L57-L63)
- [webapp/src/components/AppSidebar/index.vue:72-87](file://webapp/src/components/AppSidebar/index.vue#L72-L87)
...
## 依赖关系分析
- 组件耦合
  - DefaultLayout 与 AppHeader、AppSidebar 为组合关系；AppSidebar 依赖路由进行跳转。
  - AppHeader 依赖用户状态展示信息；AppSidebar 依赖应用状态控制折叠。
- 状态管理
...
LAYOUT --> HEADER["components/AppHeader/index.vue"]
LAYOUT --> SIDEBAR["components/AppSidebar/index.vue"]
...
- [webapp/src/stores/app.ts:10-16](file://webapp/src/stores/app.ts#L10-L16)
- [webapp/src/components/AppHeader/index.vue:24-26](file://webapp/src/components/AppHeader/index.vue#L24-L26)
...
章节来源
- [webapp/src/components/AppHeader/index.vue:23-27](file://webapp/src/components/AppHeader/index.vue#L23-L27)
