...
- [index.vue](file://webapp/src/components/AppHeader/index.vue)
- [index.vue](file://webapp/src/components/AppSidebar/index.vue)
...
AH["components/AppHeader/index.vue<br/>头部"]
AS["components/AppSidebar/index.vue<br/>侧边栏"]
end
subgraph "工具"
...
- [index.vue:1-89](file://webapp/src/components/AppHeader/index.vue#L1-L89)
- [index.vue:1-148](file://webapp/src/components/AppSidebar/index.vue#L1-L148)
...
participant SB as "侧边栏<br/>components/AppSidebar/index.vue"
V->>API : "提交账号密码登录"
API-->>V : "返回令牌与用户信息"
V->>US : "setToken(token)"
...
```mermaid
sequenceDiagram
participant Header as "头部组件<br/>AppHeader"
participant Sidebar as "侧边栏组件<br/>AppSidebar"
