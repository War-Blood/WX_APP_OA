...
const ErrorCode = {
  ...
  // ──── 考试 (3000-3099) ────
  EXAM_PAPER_NOT_FOUND: 3001,
  EXAM_PAPER_NOT_PUBLISHED: 3002,
  EXAM_SCOPE_DENIED: 3003,
  EXAM_ALREADY_DOING: 3004,
  EXAM_TIME_UP: 3005,
  EXAM_MAX_ATTEMPTS: 3006,
  EXAM_PUBLISHED_READONLY: 3007,
  EXAM_RESULT_NOT_RELEASED: 3008,
  EXAM_QUESTION_NOT_FOUND: 3010,
  EXAM_BATCH_IMPORT_ERROR: 3011,
